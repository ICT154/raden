    ...
    <div class="custom-menu notification-dropdown py-0 overflow-hidden">
        ...
        <ul class="activity-update">
            <li class="d-flex align-items-center b-l-primary">
                ...
                <div class="flex-shrink-0"> <img class="b-r-15 img-40" src="../assets/images/avatar/10.jpg"
                        alt=""></div>
            </li>
            <li class="d-flex align-items-center b-l-secondary">
                ...
                <div class="flex-shrink-0"> <img class="b-r-15 img-40" src="../assets/images/avatar/4.jpg"
                        alt=""></div>
            </li>
            <li class="d-flex align-items-center b-l-tertiary">
                ...
                <div class="flex-shrink-0"> <img class="b-r-15 img-40" src="../assets/images/avatar/1.jpg"
                        alt=""></div>
            </li>
